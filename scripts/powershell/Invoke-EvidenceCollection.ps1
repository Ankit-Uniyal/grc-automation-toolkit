...
.DESCRIPTION
    ...
    you can add/remove evidence items easily. Collection only - it never changes
    system state.
.PARAMETER EvidenceRoot
    Root evidence folder, e.g. \\fileserver\GRC\04_Evidence
.EXAMPLE
    pwsh ./Invoke-EvidenceCollection.ps1 -EvidenceRoot "\\fileserver\GRC\04_Evidence"
.NOTES
    Run under svc-grc with READ-ONLY rights wherever possible.
    Write evidence to a write-once location. Some collectors require the AD module.
#>
[CmdletBinding()]
param(
